...
if ($logType === 'acme') {
    ...
    $acmeFile = '/opt/webbadeploy/ssl/acme.json';
    ...
    // Read container logs
    $containerName = 'webbadeploy_traefik';
...
<head>
    ...
    <title>Traefik Logs - Webbadeploy</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <div class="navbar-nav ms-auto">
                    ...
                    <a class="nav-link active" href="/traefik-logs.php">
                        <i class="bi bi-file-text me-1"></i>Traefik Logs
                    </a>
