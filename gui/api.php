...
<head>
    <meta charset=\"utf-8\">
    <title><?= htmlspecialchars($site['name']) ?> - Ready</title>
    <style>
...
<head>
    <meta charset=\"utf-8\">
    <title><?= htmlspecialchars($site['name']) ?> - Laravel</title>
    <style>
        ...
        <div class=\"card\">
            ...
            <div class=\"info\">
                ...
                <div class=\"info-row\">
                    ...
                    <span class=\"value\"><?= !empty(\$_ENV['DB_HOST']) ? 'Configured' : 'Not configured' ?></span>
                </div>
            </div>
