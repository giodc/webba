    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $currentPage === 'traefik-logs.php' ? 'active' : '' ?>" href="/traefik-logs.php">
                        <i class="bi bi-file-text me-1"></i>SSL Logs
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $currentPage === 'ssl-debug.php' ? 'active' : '' ?>" href="/ssl-debug.php">
                        <i class="bi bi-shield-lock me-1"></i>SSL Debug
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $currentPage === 'debug.php' ? 'active' : '' ?>" href="/debug.php">
